...
/**
 * Clase principal que inicia la aplicación de gestión de empleados, reservas y hoteles.
 * Se conecta a la base de datos y muestra un menú interactivo para realizar operaciones CRUD.
 */
public class Main {
	/**
	 * Punto de entrada de la aplicación.
	 * Inicia la conexión a la base de datos y muestra menús para gestionar empleados, reservas y hoteles.
	 *
	...
	public static void main(String[] args) {
		...
		Scanner entrada = new Scanner(System.in); //prueba pruebaaaa
		...
		if (bbdd.init()) {
			...
			do {
				...
				// Menú principal: elegir módulo de gestión
				do {
				...
				if (!salir) {
					switch (gestion) {
						case 1:
							mostrarMenuEmpleados(entrada);
							break;
						case 2:
							mostrarMenuReservas(entrada);
							break;
						case 3:
							mostrarMenuHoteles(entrada);
							break;
					}
				}
			} while (!salir);
	 ...
	 */
	private static void mostrarMenuEmpleados(Scanner entrada) {
	...
	/**
	 * Muestra el menú de gestión de reservas y procesa las opciones.
	 *
	 * @param entrada Scanner para leer la entrada del usuario.
	 */
	private static void mostrarMenuReservas(Scanner entrada) {
	...
	/**
	 * Muestra el menú de gestión de hoteles y procesa las opciones.
	 *
	 * @param entrada Scanner para leer la entrada del usuario.
	 */
	private static void mostrarMenuHoteles(Scanner entrada) {
